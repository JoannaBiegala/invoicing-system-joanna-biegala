...
export class CompanyRow {
  ...
  async assertRowValues(taxId: string, address: string, name: string, pensionInsurance: string, healthInsurance: string) {
  ...
  async updateCompany(taxId: string, address: string, name: string, pensionInsurance: number, healthInsurance: number) {
